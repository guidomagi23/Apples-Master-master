...
public class ActividadVisualizadorPdf4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       //pdfView.fromAsset("ingenieriaI_principal_unidad2/casos_de_uso-SI.pdf").load();
        new RetrievePDFStream().execute("https://prueba610760088.files.wordpress.com/2019/10/casos_de_uso-si.pdf");
       //new RetrievePDFBytes().execute("http://cursoslared.com/recursoslibre/TutorialAndroidPrincipiantes.pdf");
        ...
        buttonDesc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Uri uri = Uri.parse("https://prueba610760088.files.wordpress.com/2019/10/casos_de_uso-si.pdf");
