...
public class ActividadVisualizadorPdf12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      // pdfView.fromAsset("ingenieriaI_extras_resumenes/ing2.pdf").load();
        new RetrievePDFStream().execute("https://prueba610760088.files.wordpress.com/2019/10/ing2.pdf");
       //new RetrievePDFBytes().execute("http://cursoslared.com/recursoslibre/TutorialAndroidPrincipiantes.pdf");
        ...
        buttonDesc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Uri uri = Uri.parse("https://prueba610760088.files.wordpress.com/2019/10/ing2.pdf");
